...
- 承载 backlog 待办池、in-progress 进行中、handoff-summary 交接摘要、handoff-next-up 下一步指引、next-up 历史兼容页 和具体开发任务
- 用于回答“当前做什么、后面做什么”
...
| `handoff-summary 交接摘要槽位` | `tasks/` | `tasks/handoff-summary.md` |
| `handoff-next-up 下一步指引槽位` | `tasks/` | `tasks/handoff-next-up.md` |
| `next-summary 下一步摘要槽位` | `tasks/` | `tasks/next-up.md`（历史兼容页，不再是当前 Stage 4 真源） |
